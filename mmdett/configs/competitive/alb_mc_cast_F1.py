...
train_pipeline = [
    ...
    dict(
        type='Resize',
        img_scale=[(1600, 960),  (1600, 720), (1600, 600)],
...
log_level = 'INFO'
load_from ="/data/weight/cast_ep39.pth"#"/data/weight/cascade_rcnn_r2_101_fpn_20e_coco-f4b7b7db.pth" #"/data/Res/cast_F1/epoch_30.pth" #"/data/weight/cast_ep39.pth" #"/media/fangxu/Disk4T/fangxuPrj/PHD-det/mmdetection/weight/cascade_rcnn_s101_fpn_syncbn-backbone+head_mstrain-range_1x_coco_20201005_113242-b9459f8f.pth"
#load_from
resume_from =None#"/data/Res/mc_cas_r2_F1/epoch_18.pth"
workflow = [('train', 1)]

work_dir ="/data/Res/alb_mc_cast_F1xxx"