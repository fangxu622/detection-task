...
train_pipeline = [
    ...
    dict(type='FixCrop', crop_type = "absolute", crop_size=(900, 1600)),
    
    dict(
        type='Resize',
        img_scale=[(1600, 900), (1600, 500)],
...
log_level = 'INFO'
load_from ="/data/weight/cast_ep39.pth" #"/media/fangxu/Disk4T/fangxuPrj/PHD-det/mmdetection/weight/cascade_rcnn_s101_fpn_syncbn-backbone+head_mstrain-range_1x_coco_20201005_113242-b9459f8f.pth"
#load_from
resume_from =None #"/media/fangxu/Disk4T/fangxuPrj/PHD-det/mmdetection/Res/cas_st_A1/epoch_40.pth"
workflow = [('train', 1)]

work_dir ="/data/Res/crop_cast_F1"