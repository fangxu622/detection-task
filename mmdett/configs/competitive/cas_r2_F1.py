...
log_level = 'INFO'
#load_from ="/data/weight/cascade_rcnn_r2_101_fpn_20e_coco-f4b7b7db.pth" #"/media/fangxu/Disk4T/fangxuPrj/PHD-det/mmdetection/weight/cascade_rcnn_s101_fpn_syncbn-backbone+head_mstrain-range_1x_coco_20201005_113242-b9459f8f.pth"
load_from =None
resume_from = "/data/Res/cas_r2_F1/epoch_25.pth"
workflow = [('train', 1)]

work_dir ="/data/Res/cas_r2_F1"
